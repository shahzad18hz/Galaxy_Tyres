  ...
  return (
    <div className="min-h-screen pt-20 bg-white">
      ...
      <section className="relative h-[40vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center bg-gradient-to-r from-background/95 via-background/80 to-background/60">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="text-4xl md:text-5xl font-bold text-foreground drop-shadow-md"
            >
